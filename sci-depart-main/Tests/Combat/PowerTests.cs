...
namespace Tests.Services
{
    ...
    public class PowerTests : BaseTests
    {
        ...
        public void HasPower()
        {
            ...
            PlayableCard playableCard = new PlayableCard(cards);
            playableCard.HasPower(1);
            Assert.IsFalse(playableCard.HasPower(2));
        }
        ...
        public void GetPowerValue()
        {
            ...
            PlayableCard playableCard = new PlayableCard(cards);
            playableCard.HasPower(1);
            Assert.AreEqual(0, playableCard.GetPowerValue(2));
        }
        ...
        public void HasPowerTrue()
        {
            ...
            PlayableCard playableCard = new PlayableCard(cards);
            playableCard.HasPower(1);
            Assert.IsTrue(playableCard.HasPower(1));
        }
        ...
        public void GetPowerValueTrue()
        {
            ...
            PlayableCard playableCard = new PlayableCard(cards);
            playableCard.HasPower(1);
            Assert.AreEqual(2, playableCard.GetPowerValue(1));
        }
    }
}
